...
df_wy <- df_wy %>% 
  ...
  select(-c(tavg, day, month, year, basinID, hillID, zoneID, patchID, topo))
...
#saveRDS(df_export, file = here("shiny", "aggregated_datasets", "df_wy.RDS"))
#saveRDS(df_export_wy0, file = here("shiny", "aggregated_datasets", "df_wy0.RDS"))
#saveRDS(df_export_wy2, file = here("shiny", "aggregated_datasets", "df_wy2.RDS"))
```
