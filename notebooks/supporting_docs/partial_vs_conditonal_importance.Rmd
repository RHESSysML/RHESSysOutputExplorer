...
readRDS(here::here("data", "rf_clim0.RDS"))
readRDS(here::here("data", "rf_clim2.RDS"))

# Importance output from permimp::permimp()
load(here::here("data", "supporting_docs_data", "permimp_sagehen_clim0.RData"))
load(here::here("data", "supporting_docs_data", "permimp_sagehen_clim2.RData"))
```
