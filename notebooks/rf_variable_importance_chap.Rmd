---
title: "Variable Importance Workflow, Chaparral - Random Forest"
...
```{r}
model_fit <- round(tail(model$finalModel$rsq, 1)*100, 2)

model$finalModel
```

The model for the base climate scenario explained `r rf0_fit`% of variance in NPP.
