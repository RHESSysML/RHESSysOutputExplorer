...
df_raw <- readRDS(here::here("data", "input", "sagehen.RDS")) 
```
...
df <- df %>% 
  ...
  select(-c(tavg, day, month, year, hillID, zoneID, patchID))
```
...
```{r}
save.image(here::here("data", "input", "prepared_data_sagehen.RData"))
```
