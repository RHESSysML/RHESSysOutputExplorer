...
#gbm_model_cv0 <- read_rds(here("models/GBm0.rds"))
saveRDS(gbm_model_cv0, file = here("data/GBm0.RDS"))
```
...
#gbm_model_cv2 <- read_rds(here("models/GBm2.rds"))
saveRDS(gbm_model_cv2, file = here("data/GBm2.RDS"))
```
...
saveRDS(imp_wy_gb0, file = here("shiny", "aggregated_datasets", "imp_wy_gb0.RDS"))
saveRDS(imp_wy_gb2, file = here("shiny", "aggregated_datasets", "imp_wy_gb2.RDS"))
```
