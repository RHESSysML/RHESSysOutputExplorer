...
source("~/MEDS/Capstone/RHESSysML_workshop/functions/summarize_removed_vars_v2.R")
...
**Need to change the function below or make different one**

```{r}
source(here("R", "get_important_predictors.R"))

# assigning first and second most important variables to objects
pred1_clim <- get_important_predictors(imp_wy, 1)
pred2_clim <- get_important_predictors(imp_wy, 2)
