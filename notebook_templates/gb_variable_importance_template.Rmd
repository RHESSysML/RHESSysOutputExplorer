...
summarize_removed_vars(df_reduced, table = TRUE)
```

#### Correlation Summary Table

```{r cor_summary_table}
summarize_cor(df_reduced, selected_removed = "removed")
```

#### Importance Summary Plot

```{r imp_summary_plot, warning=FALSE}
plot_removed_imp(df_num_preds)
```

#### VIF Summary Plot

```{r vif_summary_plot, warning=FALSE}
plot_removed_vif(df_num_preds)
```
