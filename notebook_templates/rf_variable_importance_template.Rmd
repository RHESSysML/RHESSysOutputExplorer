...
Use the `data_preparation_template.Rmd` to prepare your data before working through this notebook. It's important to note that this process relies on the specific variable names assigned throughout the workflow and problems will occur if variable names are changed. 
